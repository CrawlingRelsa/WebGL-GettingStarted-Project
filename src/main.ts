...
//import assets
import objModel from './models/bunny_lp.obj'
import shaderVert from './shader/shader.vert'
import shaderFrag from './shader/shader.frag'
import SoilCracked from './textures/SoilCracked.png.b64' //this is a base64 version of SoilCracked.png
...
function main() {
    ...
    mat4.rotateY(modelMatrix, modelMatrix, 30 * Math.PI / 180)
